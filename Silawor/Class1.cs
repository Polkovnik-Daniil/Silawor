...
namespace Silawor
{
    ...
    public class Planet_Earth
    {
        ...
        public void Country_on_the_Continent()
        {
            Planet_Earth nw = new Planet_Earth();
    ...
    class Class1
    {
        static void Main(string[] args)
        {
            ...
            Planet_Earth nw = new Planet_Earth();
            nw.Result_Sort();
            nw.Country_on_the_Continent();
            nw.number_Sea_on_the_Continent();
            nw.Del_elem();
            Console.ReadKey();
        }
    }
